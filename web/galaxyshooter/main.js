...
function updateUI(){
  UI.innerHTML = `
    <div style="font-weight:700;color:#aaf">Neon Shooter</div>
    <div style="font-size:12px;color:#9cc">Wave difficulty: ${difficulty.toFixed(2)}</div>
  `;
  hudPlayers.innerHTML = `<div style="color:#bff">P1 skin: ${players[0].skin} • P2 skin: ${players[1].skin} • Map: ${maps[selectedMap].name}</div>`;
}
...
document.getElementById('map_0').style.background = 'linear-gradient(180deg,#05010a,#090010)';
document.getElementById('map_1').style.background = 'linear-gradient(180deg,#20000a,#4a0018)';
document.getElementById('map_2').style.background = 'linear-gradient(180deg,#001a2e,#002b46)';
